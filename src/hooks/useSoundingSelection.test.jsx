...
const DATA = [
  { time: '2026-03-27T08:00', cityName: 'A' },
  { time: '2026-03-27T09:00', cityName: 'A' },
  { time: '2026-03-27T10:00', cityName: 'A' },
];
...
function SoundingSelectionProbe() {
  ...
  return (
    <div>
      ...
      <button type="button" onClick={() => selectSoundingItem(DATA[0])}>select first</button>
