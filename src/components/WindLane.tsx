...
export default function WindLane({
  ...
  if (compact) {
    return (
      <div className="lane wind-lane" style={{ height: `${COMPACT_LANE_HEIGHT}px`, position: 'relative', borderBottom: '1px solid var(--lane-border)' }}>
  ...
  return (
    <div className="lane wind-lane" style={{ height: `${LANE_HEIGHT}px`, position: 'relative', borderBottom: '1px solid var(--lane-border)' }}>
      <div className="lane-data">
