...
import ThermodynamicCandlestickLane from './ThermodynamicCandlestickLane';
      ...
      <div className="timeline-scroller">
        {hasData ? (
          <div className="lanes-container" style={{ width: 'fit-content', minWidth: '100%', position: 'relative', opacity: switching ? 0.5 : 1, transition: 'opacity 0.2s' }}>
            ...
            <UVLane data={data} />
            {!compactMode && <ThermodynamicCandlestickLane data={data} minTemp={minTemp} maxTemp={maxTemp} />}
